...
public class ReadQR extends AppCompatActivity implements ZXingScannerView.ResultHandler, OnMapReadyCallback, OnDialogButtonClickListener, OnClickListener, OnDialogWarningListener {
    ...
    private ModelRumus modelRumus = new ModelRumus(ReadQR.this);
    ...
    public void alert(Result result){
        ...
        if (inArea) {
            if (result.getText().contains(prefHelper.getString(ConstantPreferences.NAMA_PERUSAHAAN, ConstantPreferences.NAMA_PERUSAHAAN))){
                ...
                dialogsUtil.showWarning(ConstantPreferences.SCANNING, ConstantPreferences.WRONG_QRCODE,
                        ConstantPreferences.OK, ConstantPreferences.SCAN_AGAIN, this);
            }
        } else {
            dialogsUtil.showWarning(ConstantPreferences.SCANNING, ConstantPreferences.ABSENCE_NOT_ALLOWED,
                        ConstantPreferences.OK, ConstantPreferences.SCAN_AGAIN, this);
        }
    }
    ...
    public void onPositiveButtonClicked() {
        ...
        returnIntent.putExtra(ConstantPreferences.KEY_VALIDATION, ConstantPreferences.KEY_INVALIDATION);
